namespace BinarySerializer.UbiArt
{
        ...
        where UAString : UbiArtString, new()
    {
        ...
        {
            Strings = s.SerializeUbiArtObjectArray<LocStringValuePair<UAString>>(Strings, name: nameof(Strings));
